...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        bg_img.place(x=-200,y=-100,width=1920,height=1080)
        ...
        st_btn=Button(bg_img,image=self.st_photoImg,cursor="hand2",command = self.student_details)
        st_btn.place(x=1100,y=280,width=380,height=55)
        ...
        photo_btn.place(x=1100,y=390,width=380,height=55)
        ...
        train_btn.place(x=1100,y=520,width=380,height=55)
        ...
        face_btn=Button(bg_img,image=self.face_photoImg,cursor="hand2",command=self.face_data)
        face_btn.place(x=1100,y=650,width=380,height=55)
        ...
        att_btn.place(x=1100,y=780,width=380,height=55)
